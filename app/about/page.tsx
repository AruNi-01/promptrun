...
export default function AboutPage() {
  return (
    <section className="flex flex-col w-4/6">
      <title>关于我们 | PromptRun</title>
      <div className="mt-5 text-center z-10 relative">
      ...
      <p className="text-3xl cursor-default text-default-600 mt-8">开始选购 Prompt</p>
